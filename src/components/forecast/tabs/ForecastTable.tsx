...
interface IForecastTableProps {
  ...
  tableData: {
    ...
    onStatusFilterChange: (
      value: "all" | "edited" | "submitted" | "approved" | "rejected",
    ) => void;
...
const ForecastTable = ({
  ...
  const approveRoleOnlyTooltip =
    "Chỉ role có quyền xử lý luồng duyệt mới được thực hiện thao tác này.";
  const editForecastRoleOnlyTooltip =
    "Chỉ Admin hoặc Nhân viên thầu mới được thực hiện thao tác này.";
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-semibold text-foreground">
                  {totalOnPage.toLocaleString("vi-VN")}
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-muted-foreground">
                  Tổng số lượng dự trù
                </p>
                <p className="text-2xl font-semibold text-foreground">
                  {totalForecast.toLocaleString("vi-VN")}
                </p>
              </div>
          ...
          <CardContent className="p-4">
            ...
            <div className="mt-2 w-full bg-gray-200 rounded-full h-2">
              <div
                ...
                style={{
                  width: `${totalOnPage > 0 ? (approvedCount / totalOnPage) * 100 : 0}%`,
                }}
              />
            </div>
          </CardContent>
        ...
        <CardContent>
          <div className="flex flex-col gap-3 lg:flex-row lg:flex-wrap">
            ...
            <Popover
              ...
              onOpenChange={onCategoryPopoverOpenChange}
            >
            ...
            <Popover
              ...
              onOpenChange={onTypeLevel1PopoverOpenChange}
            >
              <PopoverTrigger asChild>
                <Button
                  variant="outline"
            ...
            <Popover
              ...
              onOpenChange={onTypeLevel2PopoverOpenChange}
            >
              <PopoverTrigger asChild>
                <Button
                  variant="outline"
            ...
            <Popover
              ...
              onOpenChange={onSupplierPopoverOpenChange}
            >
              <PopoverTrigger asChild>
                <Button
                  variant="outline"
        ...
        <>
                ...
                <table className="w-full table-fixed">
                    ...
                    <tr>
                      <th className="px-2 py-3 text-center text-xs font-medium whitespace-nowrap w-9">
                        <span
                          ...
                          title={selectAllDisabledTooltip}
                        >
                          <Checkbox
                            checked={
                              allSelectableRowsSelected
                            ...
                            onCheckedChange={(checked) =>
                              onToggleSelectAllRows(checked === true)
                            }
                            onClick={(e) => e.stopPropagation()}
                      ...
                      <th className="px-2 py-3 text-left text-xs font-medium whitespace-nowrap w-[80px]">
                        Mã VT
                      </th>
                      <th className="px-2 py-3 text-left text-xs font-medium w-[300px]">
                        Tên vật tư
                      </th>
                      <th className="px-2 py-3 text-left text-xs font-medium whitespace-nowrap w-[96px]">
                        Mã hiệu
                      </th>
                      <th className="px-2 py-3 text-center text-xs font-medium whitespace-nowrap w-[80px] bg-amber-600">
                        Đơn giá
                      </th>
                      ...
                      <th className="px-2 py-3 text-left text-xs font-medium whitespace-nowrap w-[120px]">
                        Nhà thầu
                      </th>
                      <th className="px-2 py-3 text-center text-xs font-medium whitespace-nowrap bg-green-600 w-[80px]">
                        Dự trù
                      </th>
                      <th className="px-2 py-3 text-center text-xs font-medium whitespace-nowrap bg-green-600 w-[70px]">
                        Gọi hàng
                      </th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-border">
                    {typeGroups.map((group) => {
                      ...
                      const selectableGroupItems = group.items.filter((item) =>
                        isRowSelectable(item),
                      );
                      const selectedGroupCount = selectableGroupItems.filter(
                        (item) => isRowSelected(item),
                      ).length;
                      ...
                      const groupSelectDisabled =
                        !canSelectRowsRole || selectableGroupItems.length === 0;
                                ...
                                <div className="flex items-center gap-2 min-w-0">
                                  <span
                                    ...
                                    title={
                                      groupSelectDisabled
                                        ? approveRoleOnlyTooltip
                                        : "Chọn tất cả vật tư con của mã này"
                                    }
                                  >
                                    <Checkbox
                              ...
                              >
                                ...
                                >
                                  {(() => {
                                    ...
                                    const rowSelectDisabledTooltip =
                                      !canSelectRowsRole
                                        ? approveRoleOnlyTooltip
                                        : !rowSelectable
                                    ...
                                    return (
                                      <span
                                        className="inline-flex"
                                        title={rowSelectDisabledTooltip}
                                      >
                                        <Checkbox
                                ...
                                <td className="px-2 py-3 text-xs text-foreground">
                                  <div
                                    className="max-w-[96px] truncate font-mono"
                                    title={item.maHieu || ""}
                                  >
                                    {item.maHieu || "—"}
                                  </div>
                                ...
                                <td
                                  className="px-2 py-3 bg-green-50 dark:bg-green-950/30"
                                  onClick={(e) => e.stopPropagation()}
                                >
                                  {(() => {
                                    const forecastEditable =
                                      isForecastEditable(item) && !isReadOnly;
                                    const forecastInputDisabledTooltip =
                                      isReadOnly
                                    ...
                                    return (
                                      <span
                                        className="inline-flex"
                                        title={forecastInputDisabledTooltip}
                                      >
                                        <Input
                                          type="number"
                                          min="0"
                                          ...
                                          onFocus={() =>
                                            onForecastFocus(item, item.duTru)
                                          }
                                          onBlur={(e) =>
                                            onForecastBlur(
                                              item,
                  ...
                  <tfoot className="bg-tertiary border-t-2 border-border">
                    <tr>
                      <td
                        colSpan={9}
                        className="px-3 py-3 text-sm font-semibold text-foreground text-right"
                      >
                        Tổng cộng:
                      </td>
                      <td className="px-3 py-3 text-sm font-semibold text-foreground text-center bg-green-100 dark:bg-green-950/50">
                        {filteredData.reduce(
                          (sum, item) => sum + item.duTru,
                          0,
                        )}
                      </td>
                      <td className="px-3 py-3 text-sm font-semibold text-foreground text-center bg-green-100 dark:bg-green-950/50">
                        {filteredData.reduce(
                          (sum, item) => sum + item.goiHang,
                          0,
                        )}
                      </td>
                    </tr>
          ...
          {(isSearching ||
            ...
            <div className="text-center text-sm text-muted-foreground">
              Đang hiển thị {filteredData.length} / {totalOnPage} vật tư (đã
              filter)
            </div>
          )}
        </>
